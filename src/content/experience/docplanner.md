...
bullets:
  ...
  - en: "Acted as tech driver on Monetization: project management, delivery and technical direction; primary front-end liaison for product and design."
    es: "Actué como tech driver en Monetization: gestión de proyectos, entrega y dirección técnica; enlace front-end principal con producto y diseño."
  - en: "Shipped those Monetization surfaces as microfrontends, so the team could own and release independently while sharing design-system components."
    es: "Lancé esas superficies de Monetization como microfrontends, para publicar de forma independiente compartiendo design system."
  - en: "Ran A/B tests on onboarding, paid features and upsells across multiple markets."
